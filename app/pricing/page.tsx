...
export const metadata = { title: "Pricing", description: "Location-based pricing for 11i Maps listings management, review workflows and local SEO.", alternates: { canonical: "/pricing" } };
